...
Route::middleware('auth')->group(function () {
    ...
    Route::post('/tweets/{tweet}/like', 'TweetLikesController@store')->name('tweets.like.store');
    Route::delete('/tweets/{tweet}/like', 'TweetLikesController@destroy')->name('tweets.like.destroy');
